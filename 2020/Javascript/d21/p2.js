...
function sol(data) {
    ...
    // EXAMINE OUTPUT TO CALCULATE BELOW
    let ingreMap = {};
    ingreMap["kdqls"] = "soy";
    ...
    let alphaByAller = Object.keys(ingreMap);
    alphaByAller.sort((a, b) => {
        let q = [ingreMap[a], ingreMap[b]];
        q.sort();
        return (q[0] == ingreMap[a]) ? -1 : 1;
    });

    return alphaByAller.join(",");
}
